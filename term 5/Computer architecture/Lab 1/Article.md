...
Тут и проявляется опасность коллизий. Злоумышленник может подобрать такие данные, которые при хешировании дадут одинаковый с паролем хеш. Как следствие - можно ввести эти данные вместо пароля и получить доступ к чужому аккаунту. 
...
2) Сопротивлению поиску прообраза. Это означает, что хеш-функция должна быть односторонней и по хешу невозможно восстановить входные данные.
...
**Вывод: выбор ненадежной хеш функции может привести к серьезным проблемам безопасности системы.**
